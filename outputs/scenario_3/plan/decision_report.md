...
- Total requests: 400
- Input tokens: P50=1280, P90=4422, P99=5743
- Output tokens: P50=458, P90=2105, P99=2977
- Average RPS: 0.11, Peak RPS: 0.22
- Burst ratio: 1.94
- Prefix reuse rate: 98.52%
- Estimated concurrency: 1.8
...
- SLO: P95 TTFT ≤ 1500.0ms, P95 ITL ≤ 50.0ms
- Max GPU count: 16
- Min quality retention: 0.98
...
- Estimated peak memory per GPU: 25.3 GB
- Model weight per GPU: 7.5 GB
- KV cache per token: 65536 bytes

## Capacity & Headroom

- Estimated capacity headroom: 97.64%
- Required minimum: 15%
...
- P95 TTFT: 575ms (SLO: 1500.0ms)
- P95 ITL: 16ms (SLO: 50.0ms)
